    ...
    <div className="landing-container">
      ...
      <section className="video-section">
        {hasVideo ? (
          ...
          <div className="video-placeholder">
            {userData.video_status === 'FAILED' ? '체험 영상 제작에 실패했어요.' : '체험 영상을 준비 중입니다...'}
          </div>
        )}
        <button className="primary-btn" disabled={!hasVideo} onClick={downloadVideo}>
      ...
      <section className="aura-card">
        ...
        <div className="info-grid">
          ...
          <span className="info-value">{soulTag.bag_name || bag.name || '-'}</span>
          ...
          <span className="info-value">{soulTag.styling || accessory.name || '-'}</span>
      ...
      <div className="product-card transparent-card">
          ...
          <div className="transparent-content">
            ...
            <div className="product-text">
              ...
              <p className="product-desc">{accessory.name || soulTag.styling || '-'}</p>
              <div className="button-group">
                <button className="outline-btn">제품 보기</button>
                <button className="solid-btn">
                  <img src="/purchase.svg" alt="purchase" className="btn-icon" />
